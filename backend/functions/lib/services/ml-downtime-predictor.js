...
exports.mlDowntimePredictor = void 0;
class MLDowntimePredictor {
    ...
    updateWeights(features, error, learningRate) {
    ...
    generateRecommendation(probability, factors) {
        if (probability > 0.7) {
...
exports.mlDowntimePredictor = new MLDowntimePredictor();
//# sourceMappingURL=ml-downtime-predictor.js.map